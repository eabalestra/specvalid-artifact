...
- **Archival repository (Zenodo DOI):** <https://doi.org/10.5281/zenodo.18899070>
...
1. Specs generated by **SpecFuzzer** ([website](https://sites.google.com/view/specfuzzer/inicio) — see its artifact for instructions)
2. A Randoop-generated test suite targeting that method (SpecFuzzer uses Randoop internally, so the suite and driver follow Randoop's output format)
...
| `<test_suite>`             | Test suite `.java`                      | `SimpleMethodsTester0.java`                            |
| `<test_driver>`            | Test driver `.java`                     | `SimpleMethodsTesterDriver.java`                       |
