...
(assert (= Integer_Variable__var426 (+ Integer_Variable_Orig__var426 Integer_Variable_Orig_y)))
(assert (or (<= Integer_Variable_Orig_y 0) (= Integer_Variable__var23 (+ Integer_Variable_Orig__var23 Integer_Variable_Orig_y)))) 
