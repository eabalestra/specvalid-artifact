...
class SMTLIBTranslator:
    ...
    def _generate_smtlib(self, translated_exprs, ground_truth_expr):
        ...
        declarations += "\n(assert (= Integer_Variable_Orig_y Integer_Variable_y))\n"
...
if __name__ == "__main__":
    ...
    try:
        ground_truth = "(= Integer_Variable__var426 (+ Integer_Variable_Orig__var426 Integer_Variable_Orig_y))"
        # ground_truth = "(or (<= Integer_Variable_Orig_y 0) (= Integer_Variable__var23 (+ Integer_Variable_Orig__var23 Integer_Variable_Orig_y)))"
