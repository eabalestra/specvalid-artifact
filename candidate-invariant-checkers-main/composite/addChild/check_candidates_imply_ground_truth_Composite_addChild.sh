...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-addChild.als 2> alloy-output.txt
...
cat alloy-inv-checker-addChild.als groundtruth-checks.als > check-gt.als
