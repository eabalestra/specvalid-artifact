...
fact preconditionComposite {
	...
	-- parent is converse of children in pre
	all c1, c2: Composite | c1 -> c2 in SK.pre_children iff c2 -> c1 in SK.pre_parent
...
pred groundTruth2[] {
	...
	-- children is converse of parent
	(all c1, c2: Composite | (c1 -> c2) in (SK.post_children) iff (c2 -> c1) in (SK.post_parent))
}
