...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-incrementNumberAtIndex.als 2> alloy-output.txt
...
cat alloy-inv-checker-incrementNumberAtIndex.als groundtruth-checks.als > check-gt.als
