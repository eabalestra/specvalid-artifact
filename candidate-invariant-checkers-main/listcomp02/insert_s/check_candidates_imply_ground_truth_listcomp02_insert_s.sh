...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-insert_s.als 2> alloy-output.txt
...
cat alloy-inv-checker-insert_s.als groundtruth-checks.als > check-gt.als
