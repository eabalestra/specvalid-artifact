...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-insert_r.als 2> alloy-output.txt
...
cat alloy-inv-checker-insert_r.als groundtruth-checks.als > check-gt.als
