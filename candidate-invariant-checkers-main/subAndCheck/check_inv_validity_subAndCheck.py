...
(assert (= Long_Variable_return (- Long_Variable_Orig_a Long_Variable_Orig_b)))
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.stderr.write("Usage: python check_inv_validity_subAndCheck.py \"formula\"\n")
        sys.stderr.write("Example: python check_inv_validity_subAndCheck.py \"(Long_Variable_0 = 1)\"\n")
        sys.exit(1)
