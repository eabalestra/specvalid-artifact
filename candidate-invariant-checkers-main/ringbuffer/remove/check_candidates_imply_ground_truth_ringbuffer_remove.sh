...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-remove.als 2>alloy-output.txt
...
cat alloy-inv-checker-remove.als groundtruth-checks.als >check-gt.als
