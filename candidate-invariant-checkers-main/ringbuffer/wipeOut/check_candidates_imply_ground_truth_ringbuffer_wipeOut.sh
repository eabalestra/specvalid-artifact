...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-wipeOut.als 2>alloy-output.txt
...
cat alloy-inv-checker-wipeOut.als groundtruth-checks.als >check-gt.als
