...
rm -f alloy-inv-checker-wipeOut.als
cat alloy-checker-prelude-wipeOut.als generated-preds.txt >alloy-inv-checker-wipeOut.als

echo "Checking validity of candidate invariants using Alloy..."
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-wipeOut.als 2>&1
total_wipeOut=$(grep "run" alloy-inv-checker-wipeOut.als | wc -l | awk '{print $1}')
echo "total_candidates: $total_wipeOut"
