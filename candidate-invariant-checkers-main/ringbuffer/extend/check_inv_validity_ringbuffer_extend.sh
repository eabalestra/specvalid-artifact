...
rm -f alloy-inv-checker-extend.als
cat alloy-checker-prelude-extend.als generated-preds.txt >alloy-inv-checker-extend.als

echo "Checking validity of candidate invariants using Alloy..."
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-extend.als 2>&1
total_extend=$(grep "run" alloy-inv-checker-extend.als | wc -l | awk '{print $1}')
echo "total_candidates: $total_extend"
