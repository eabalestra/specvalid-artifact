...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-extend.als 2>alloy-output.txt
...
cat alloy-inv-checker-extend.als groundtruth-checks.als >check-gt.als
