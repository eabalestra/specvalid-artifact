...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-topAndPop.als 2> alloy-output.txt
...
cat alloy-inv-checker-topAndPop.als groundtruth-checks.als > check-gt.als
