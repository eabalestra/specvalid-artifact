...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-dequeueAll.als 2> alloy-output.txt
...
cat alloy-inv-checker-dequeueAll.als groundtruth-checks.als > check-gt.als
