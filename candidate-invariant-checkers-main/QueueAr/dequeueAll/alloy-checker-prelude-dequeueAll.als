...
-- This checker is for the dequeueAll method
one sig Null { }
sig Elem { }
sig QueueAr {
...
-- currentSize is 0 after dequeueAll.
pred groundTruth2[] {
    SK.q1.currentSize = 0
}
-- front is equal to back + 1 or 0 after dequeueAll.
pred groundTruth3[] {
    SK.q1.front = 0 or SK.q1.front = add[SK.q.back, 1]
}
-- back didn't change after dequeueAll.
pred groundTruth4[] {
    SK.q1.back = SK.q.back
}
-- array contains all null objects after dequeueAll.
pred groundTruth5[] {
    all i: Int | i >= 0 and i < SK.q1.size implies SK.q1.arr[i] = Null
}
