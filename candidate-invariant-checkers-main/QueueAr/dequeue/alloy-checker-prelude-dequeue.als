...
-- This checker is for the dequeue method
one sig Null { }
sig Elem { }
sig QueueAr {
...
-- back dind't change after dequeue.
pred groundTruth2[] {
    SK.q1.back = SK.q.back
}
-- currentSize is decreased after dequeue.
pred groundTruth3[] {
    SK.q1.currentSize = sub[SK.q.currentSize,1]
}
-- front is increased or 0 after dequeue.
pred groundTruth4[] {
    SK.q1.front = 0 or SK.q1.front = add[SK.q.front, 1]
}
-- Previous front position in array is set to null after dequeue.
pred groundTruth5[] {
    SK.q1.arr[SK.q.front] = Null
}
