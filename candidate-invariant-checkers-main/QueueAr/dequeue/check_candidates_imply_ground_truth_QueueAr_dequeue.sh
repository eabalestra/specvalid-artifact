...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-dequeue.als 2> alloy-output.txt
...
cat alloy-inv-checker-dequeue.als groundtruth-checks.als > check-gt.als
