...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-getFront.als 2> alloy-output.txt
...
cat alloy-inv-checker-getFront.als groundtruth-checks.als > check-gt.als
