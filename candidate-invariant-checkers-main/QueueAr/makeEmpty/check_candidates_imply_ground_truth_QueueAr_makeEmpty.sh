...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-makeEmpty.als 2> alloy-output.txt
...
cat alloy-inv-checker-makeEmpty.als groundtruth-checks.als > check-gt.als
