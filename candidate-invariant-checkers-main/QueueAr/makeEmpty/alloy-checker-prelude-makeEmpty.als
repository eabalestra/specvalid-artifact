...
-- This checker is for the makeEmpty method
one sig Null { }
sig Elem { }
sig QueueAr {
...
-- currentSize is 0 after makeEmpty.
pred groundTruth2[] {
    SK.q1.currentSize = 0
}
-- front is 0 after makeEmpty.
pred groundTruth3[] {
    SK.q1.front = 0
}
-- back is size - 1 after makeEmpty.
pred groundTruth4[] {
    SK.q1.back = sub[SK.q1.size,1]
}
-- array contains all null objects after makeEmpty.
pred groundTruth5[] {
