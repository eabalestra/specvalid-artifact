...
def translate_assertion(assertion_line, predicate_counter):
    ...
    if match:
        ...
        if not nav1:
            nav1 = ""
        alloy_field_1 = translate_single_field(field1)
        nav1 = nav1.replace('left', '(SK.post_left)').replace('right', '(SK.post_right)')
    ...
    if match:
        ...
        nav = nav.replace('left', 'SK.pre_left').replace('right', 'SK.pre_right')
        opr2 = opr2.replace('left', '(SK.pre_left)').replace('right', '(SK.pre_right)')
    ...
    if match:
        ...
        nav = nav.replace('left', 'SK.post_left').replace('right', 'SK.post_right')
        opr2 = opr2.replace('left', '(SK.post_left)').replace('right', '(SK.post_right)')
    ...
    if match:
        ...
        nav1 = nav1.replace('left', 'SK.post_left').replace('right', 'SK.post_right')
        nav2 = nav2.replace('left', '(SK.post_left)').replace('right', '(SK.post_right)')
        nav3 = nav3.replace('left', '(SK.post_left)').replace('right', '(SK.post_right)')
...
def translate_single_field(field):
    ...
    if field == "n":
        return "SK.node_to_insert"

    return field.replace('this.', '(SK.post_this).').replace('n.', '(SK.node_to_insert).').replace('left', '(SK.post_left)').replace('right', '(SK.post_right)')
...
def translate_singled_old_field(field):
    ...
    return field.replace('this.', '(SK.pre_this).').replace('n.', '(SK.node_to_insert).').replace('left', '(SK.pre_left)').replace('right', '(SK.pre_right)')
