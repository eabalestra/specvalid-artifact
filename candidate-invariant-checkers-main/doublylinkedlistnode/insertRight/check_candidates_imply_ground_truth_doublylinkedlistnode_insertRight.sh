...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-insertRight.als 2> alloy-output.txt
...
cat alloy-inv-checker-insertRight.als groundtruth-checks.als > check-gt.als
