...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.stderr.write("Usage: python check_candidate_imply_ground_truth_1_copySignInt.py \"formula\"\n")
        sys.stderr.write("Example: python check_candidate_imply_ground_truth_1_copySignInt.py \"(Integer_Variable_0 = 1)\"\n")
        sys.exit(1)
