...
(assert (or (not (and (>= Integer_Variable_Orig_magnitude 0) (>= Integer_Variable_Orig_sign 0))) (= Integer_Variable_return Integer_Variable_Orig_magnitude)))
(assert (or (not (and (< Integer_Variable_Orig_magnitude 0) (< Integer_Variable_Orig_sign 0))) (= Integer_Variable_return Integer_Variable_Orig_magnitude)))
(assert (or (not (and (>= Integer_Variable_Orig_magnitude 0) (< Integer_Variable_Orig_sign 0))) (= Integer_Variable_return (* Integer_Variable_Orig_magnitude -1)))) 
(assert (or (not (and (< Integer_Variable_Orig_magnitude 0) (>= Integer_Variable_Orig_sign 0))) (= Integer_Variable_return (* Integer_Variable_Orig_magnitude -1)))) 
