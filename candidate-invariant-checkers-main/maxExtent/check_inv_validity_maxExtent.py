...
(assert (or (= Double_Variable_return 0) (or (= Double_Variable_return w) (= Double_Variable_return h))))
(assert (or (not (< Double_Variable_maxx Double_Variable_minx)) (= Double_Variable_return 0)))
(assert (or (not (and (>= Double_Variable_maxx Double_Variable_minx) (> w h))) (= Double_Variable_return w)))
(assert (or (not (and (>= Double_Variable_maxx Double_Variable_minx) (<= w h))) (= Double_Variable_return h)))
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.stderr.write("Usage: python check_inv_validity_maxExtent.py \"formula\"\n")
        sys.stderr.write("Example: python check_inv_validity_maxExtent.py \"(Integer_Variable_0 = 1)\"\n")
        sys.exit(1)
