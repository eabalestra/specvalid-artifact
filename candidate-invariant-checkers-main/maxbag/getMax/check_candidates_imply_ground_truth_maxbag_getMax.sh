...
java -jar ../../alloy/AlloyCommandline.jar alloy-inv-checker-getMax.als 2> alloy-output.txt
...
cat alloy-inv-checker-getMax.als groundtruth-checks.als > check-gt.als
