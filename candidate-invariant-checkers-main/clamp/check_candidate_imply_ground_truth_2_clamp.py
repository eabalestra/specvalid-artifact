...
if __name__ == "__main__":
    ...
    try:
        # ground_truth = "(or (not (< Integer_Variable_Orig_x Integer_Variable_Orig_min)) (= Integer_Variable_return Integer_Variable_Orig_min))"
        ground_truth = "(or (not (and (>= Integer_Variable_Orig_x Integer_Variable_Orig_min) (> Integer_Variable_Orig_x Integer_Variable_Orig_max))) (= Integer_Variable_return Integer_Variable_Orig_max))"
        # ground_truth = "(or (not (and (>= Integer_Variable_Orig_x Integer_Variable_Orig_min) (<= Integer_Variable_Orig_x Integer_Variable_Orig_max))) (= Integer_Variable_return Integer_Variable_Orig_x))"
