...
(assert (or (= Integer_Variable_return Integer_Variable_Orig_a) (= Integer_Variable_return Integer_Variable_Orig_b)))
(assert (<= Integer_Variable_return Integer_Variable_Orig_a)) 
(assert (<= Integer_Variable_return Integer_Variable_Orig_b)) 
