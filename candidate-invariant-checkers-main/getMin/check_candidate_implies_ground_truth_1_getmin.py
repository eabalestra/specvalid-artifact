...
class SMTLIBTranslator:
    ...
    def _collect_variables(self, expr):
        ...
        self.variables.add('Integer_Variable_Orig_a')
        self.variables.add('Integer_Variable_Orig_b')
...
if __name__ == "__main__":
    ...
    try:
        ground_truth = "(or (= Integer_Variable_return Integer_Variable_Orig_a) (= Integer_Variable_return Integer_Variable_Orig_b))"
        #ground_truth = "(<= Integer_Variable_return Integer_Variable_Orig_a)"
        #ground_truth = "(<= Integer_Variable_return Integer_Variable_Orig_b)"
