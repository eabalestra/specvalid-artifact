...
(assert (or (not (= Boolean_Variable_Orig_x Boolean_Variable_Orig_y)) (= Integer_Variable_return 0)))
(assert (or (not (and (not Boolean_Variable_Orig_x) Boolean_Variable_Orig_y)) (< Integer_Variable_return 0)))
(assert (or (not (and Boolean_Variable_Orig_x (not Boolean_Variable_Orig_y))) (> Integer_Variable_return 0)))
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.stderr.write("Usage: python check_inv_validity_compare.py \"formula\"\n")
        sys.stderr.write("Example: python check_inv_validity_compare.py \"(Boolean_Variable_0 = 1)\"\n")
        sys.exit(1)
