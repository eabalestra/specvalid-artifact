...
class SMTLIBTranslator:
    ...
    def _generate_smtlib(self, translated_exprs, ground_truth_expr):
        ...
        result = result + "(assert (>= Integer_Variable_Orig_x -2147483648))\n"
        result = result + "(assert (<= Integer_Variable_Orig_x 2147483647))\n"
        result = result + "(assert (>= Integer_Variable_return -2147483648))\n"
        result = result + "(assert (<= Integer_Variable_return 2147483647))\n"
...
if __name__ == "__main__":
    ...
    try:
        #ground_truth = "(or (not (= Integer_Variable_Orig_x -2147483648)) (= Integer_Variable_return -2147483648))"
        ground_truth = "(or (= Integer_Variable_Orig_x -2147483648) (>= Integer_Variable_return 0))"
        #ground_truth = "(or (= Integer_Variable_Orig_x -2147483648) (or (= Integer_Variable_return Integer_Variable_Orig_x) (= Integer_Variable_return (- Integer_Variable_Orig_x))))"
