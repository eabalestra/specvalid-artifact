...
(assert (>= Integer_Variable_Orig_x -2147483648))
(assert (<= Integer_Variable_Orig_x 2147483647))
(assert (>= Integer_Variable_return -2147483648))
(assert (<= Integer_Variable_return 2147483647))
(assert (or (not (= Integer_Variable_Orig_x -2147483648)) (= Integer_Variable_return -2147483648)))
(assert (or (= Integer_Variable_Orig_x -2147483648) (>= Integer_Variable_return 0)))
(assert (or (= Integer_Variable_return Integer_Variable_Orig_x) (= Integer_Variable_return (- Integer_Variable_Orig_x)))) 
